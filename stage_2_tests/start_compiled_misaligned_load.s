...
emulate_misaligned_lw:
#	csrr	t0, mtval	# misaligned address
	csrr	t0, 0x343	# mtval: misaligned address
	andi	t1, t0, -4      # round address down to aligned boundary
	addi	t2, t1, 4	# aligned address of next word
	lw	t1, 0(t1)	# get first word containing least significant bytes
	lw	t2, 0(t2)       # get second word containing most significant bytes
	andi	t0, t0, 3	# byte offset from aligned boundary
	slli	t0, t0, 3	# bit offset from aligned boundary
	srl	t1, t1, t0	# shift ls bits down to bit 0, clearing ms bits
	addi	t0, t0, -32	# calculate 32 - bit offset = -(bit offset - 32)
	sub	t0, zero, t0
	sll	t2, t2, t0      # shift ms bits up to bit 31
	...
	lw	t0, 0(t0)	# get load instruction word
